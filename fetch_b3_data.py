...
# Função para simular variação de preço (para você ver o gráfico mudando)
...
# No futuro, você pode substituir os valores fixos por chamadas ao yfinance ou investpy
data = [
  {
    "id": "1",
    "ticker": "WEGE3",
...
try:
    ...
    print(f"Sucesso! Arquivo '{file_path}' gerado com {len(data)} ativos.")
